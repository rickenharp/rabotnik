  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved keyword as @keyword" do
        ...
        post :create, {:keyword => { "content" => "invalid value" }}, valid_session
        assigns(:keyword).should be_a_new(Keyword)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested keyword" do
        ...
        Keyword.any_instance.should_receive(:update_attributes).with({ "content" => "MyString" })
        put :update, {:id => keyword.to_param, :keyword => { "content" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the keyword as @keyword" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Keyword.any_instance.stub(:save).and_return(false)
        put :update, {:id => keyword.to_param, :keyword => { "content" => "invalid value" }}, valid_session
        assigns(:keyword).should eq(keyword)
      end
